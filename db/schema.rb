...
ActiveRecord::Schema.define(version: 2020_03_01_225445) do
  ...
  create_table "olympian_events", force: :cascade do |t|
    ...
    t.index ["olympian_id", "event_id"], name: "index_olympian_events_on_olympian_id_and_event_id", unique: true
